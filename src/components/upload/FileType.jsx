            ...
            >
              <div className="card-body">
                <div className="cappadd">
                  ...
                  <DashboardDropDown  projectData={this.props.data}  handleDeleteProject={this.props.handleDeleteProject} />
                </div>
              </div>
            </div>
          )}
          {this.props.userFileData && this.props.data.type === "video" && (
            <div className="card-body">
              ...
              <div className="cappadd">
                ...
                <DashboardDropDown  projectData={this.props.data}    handleDeleteProject={(d)=>{}} />
              </div>
            </div>
          )}
